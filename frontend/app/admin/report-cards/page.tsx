...
import { IconFileText, IconChevronRight, IconSearch, IconFileAnalytics } from '@tabler/icons-react';
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <Typography variant="body" className="text-muted-foreground mt-2">
            Gestion, génération et validation des livrets scolaires par classe.
          </Typography>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredClasses.map((cls, idx) => (
            ...
            >
              <Link href={`/admin/report-cards/${cls.id}`}>
                  ...
                  <div className="flex justify-between items-start relative z-10">
                    <div>
                      ...
                      <Typography variant="body" className="text-xs text-muted-foreground mt-1">
                        Gérer les bulletins ({cls._count?.students || 0} élèves)
                      </Typography>
                    </div>
