...
exports.getPaymentConfirmationEmail = getPaymentConfirmationEmail;
const base_1 = require("./base");
function getPaymentConfirmationEmail(parentName, amount, feeType, status, reference) {
    const content = `
  ...
  `;
    return (0, base_1.getBaseTemplate)({ title: "Confirmation de votre paiement", content });
}
